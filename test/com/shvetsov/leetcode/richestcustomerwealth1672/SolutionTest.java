...
class SolutionTest {
    ...
    @Test
    void shouldReturnMaxSumOfElementsInInnerArray() {
        assertThat(solution.maximumWealth(case1)).isEqualTo(6);
        assertThat(solution.maximumWealth(case2)).isEqualTo(10);
        assertThat(solution.maximumWealth(case3)).isEqualTo(17);
        assertThat(solution.maximumWealth(case4)).isEqualTo(1063);
    }
}